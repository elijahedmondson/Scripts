...
//def path = buildFilePath('C:/Users/edmondsonef/Desktop/QuPath/NCL/Tox 175/', 'iNOS')
//def path = buildFilePath('P:/archive/PHL/Edmondson/QuPath/Young/PHL 190350/', 'iNOS')
def path = buildFilePath(PROJECT_BASE_DIR, 'iNOS')
mkdirs(path)

...
def path = buildFilePath('C:/Users/edmondsonef/Desktop/QuPath/Dong Zhang/ER CD8/', 'CD8')
//def path = buildFilePath('P:/archive/PHL/Edmondson/QuPath/Alewine/PHL 190380/', 'CD8')
mkdirs(path)

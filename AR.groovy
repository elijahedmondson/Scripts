...
setColorDeconvolutionStains('{"Name" : "H-DAB default", "Stain 1" : "Hematoxylin", "Values 1" : "0.65111 0.70119 0.29049 ", "Stain 2" : "DAB", "Values 2" : "0.26917 0.56824 0.77759 ", "Background" : " 240 240 242 "}');
...
runClassifier('P:\\archive\\PHL\\Edmondson\\Qupath\\Jagoda\\PHL 190360\\classifiers\\AR.qpclassifier');


//SAVE ANNOTATIONS //
def name = getProjectEntry().getImageName() + '.txt'
def path = buildFilePath(PROJECT_BASE_DIR, 'AR')
mkdirs(path)

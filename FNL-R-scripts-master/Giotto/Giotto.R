...
## sNN network (default)
gobj <- createNearestNetwork(gobject = gobj, dimensions_to_use = 1:14, k = 20)

## 0.1 resolution
gobj <- doLeidenCluster(gobject = gobj, resolution = 0.5, n_iterations = 100, name = 'leiden',python_path = python_path)

codex_metadata = pDataDT(gobj)

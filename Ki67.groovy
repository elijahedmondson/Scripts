...
saveAnnotationMeasurements('C:/Users/edmondsonef/Desktop/QuPath/Sayers/2018.3/F480/');


//SAVE ANNOTATIONS //

def name = getProjectEntry().getImageName() + '.txt'
//def path = buildFilePath('C:/Users/edmondsonef/Desktop/QuPath/Alewine/PHL 190357/', 'annotation results')
def path = buildFilePath(PROJECT_BASE_DIR, 'Ki67')
mkdirs(path)

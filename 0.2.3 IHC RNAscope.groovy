...
runPlugin('qupath.imagej.detect.cells.SubcellularDetection', '{"detection[DAB]": 0.2,  "doSmoothing": true,  "splitByIntensity": true,  "splitByShape": true,  "spotSizeMicrons": 2.0,  "minSpotSizeMicrons": 0.1,  "maxSpotSizeMicrons": 6.0,  "includeClusters": true}');
